...
try:
    ...
    tokenizer = Tokenizer()
    # Fit on some basic data to initialize
...
def wishMe():
    ...
    if(hour>=0) and (hour<=12) and ('AM' in t):
        speak(f"Good morning Latha, it's {day} and the time is {t}")
    elif(hour>=12)  and (hour<=16) and ('PM' in t):
        speak(f"Good afternoon Latha, it's {day} and the time is {t}")
    else:
        speak(f"Good evening Latha, it's {day} and the time is {t}")
...
def schedule():
    day = cal_day().lower()
    speak("Latha today's schedule is ")
    week={
    "monday": "Latha, from 9:00 to 9:50 you have Algorithms class, from 10:00 to 11:50 you have System Design class, from 12:00 to 2:00 you have a break, and today you have Programming Lab from 2:00 onwards.",
    "tuesday": "Latha, from 9:00 to 9:50 you have Web Development class, from 10:00 to 10:50 you have a break, from 11:00 to 12:50 you have Database Systems class, from 1:00 to 2:00 you have a break, and today you have Open Source Projects lab from 2:00 onwards.",
    "wednesday": "Latha, today you have a full day of classes. From 9:00 to 10:50 you have Machine Learning class, from 11:00 to 11:50 you have Operating Systems class, from 12:00 to 12:50 you have Ethics in Technology class, from 1:00 to 2:00 you have a break, and today you have Software Engineering workshop from 2:00 onwards.",
    "thursday": "Latha, today you have a full day of classes. From 9:00 to 10:50 you have Computer Networks class, from 11:00 to 12:50 you have Cloud Computing class, from 1:00 to 2:00 you have a break, and today you have Cybersecurity lab from 2:00 onwards.",
    "friday": "Latha, today you have a full day of classes. From 9:00 to 9:50 you have Artificial Intelligence class, from 10:00 to 10:50 you have Advanced Programming class, from 11:00 to 12:50 you have UI/UX Design class, from 1:00 to 2:00 you have a break, and today you have Capstone Project work from 2:00 onwards.",
    "saturday": "Latha, today you have a more relaxed day. From 9:00 to 11:50 you have team meetings for your Capstone Project, from 12:00 to 12:50 you have Innovation and Entrepreneurship class, from 1:00 to 2:00 you have a break, and today you have extra time to work on personal development and coding practice from 2:00 onwards.",
    "sunday": "Latha, today is a holiday, but keep an eye on upcoming deadlines and use this time to catch up on any reading or project work."
    }
    if day in week.keys():
        speak(week[day])
...
def browsing(query):
    if 'google' in query:
        speak("Latha, what should i search on google..")
        s = command().lower()
        if s != "none":
            search_url = f"https://www.google.com/search?q={s.replace(' ', '+')}"
            webbrowser.open(search_url)
            speak(f"Searching for {s} on Google")
        else:
...
def condition():
    ...
    speak(f"Latha our system have {percentage} percentage battery")

    if percentage>=80:
        speak("Latha we could have enough charging to continue our recording")
    elif percentage>=40 and percentage<=75:
        speak("Latha we should connect our system to charging point to charge our battery")
    else:
        speak("Latha we have very low power, please connect to charging otherwise recording should be off...")
